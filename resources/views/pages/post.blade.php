<x-layouts.app :title="__('Home')">
    <flux:link wire:navigate href="{{ route('posts.AddPost') }}" style="text-decoration: none">
        <flux:text style="color: #fff;" class=" dark:bg-gray-800 dark:border-gray-700 p-6 rounded-md w-xs">Add New Posts
        </flux:text>
    </flux:link>
    <br>
